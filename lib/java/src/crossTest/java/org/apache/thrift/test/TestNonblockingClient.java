  ...
  public static void main(String[] args) {
    ...
    try {
      if (ssl) {
        ...
        transport =
            TSSLTransportFactory.getNonblockingClientSocket(host, port, socketTimeout, params);
      } else {
    ...
    ThriftTest.AsyncClient testClient =
        new ThriftTest.AsyncClient(tProtocolFactory, clientManager, transport);
